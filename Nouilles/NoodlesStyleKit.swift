...
public class NoodlesStyleKit : NSObject {
    ...
    private struct Cache {
        ...
        static let warning: UIColor = UIColor(red: 1.000, green: 0.000, blue: 0.000, alpha: 1.000)
        static let success: UIColor = UIColor(red: 0.742, green: 0.927, blue: 0.079, alpha: 1.000)
        ...
        static let glutenFreeColor: UIColor = UIColor(red: 0.269, green: 0.646, blue: 0.443, alpha: 1.000)
        ...
        static var imageOfGlutenFreeBadge: UIImage?
        static var glutenFreeBadgeTargets: [AnyObject]?
        static var imageOfLongNoodles: UIImage?
        static var longNoodlesTargets: [AnyObject]?
    }
    ...
    public dynamic class var warning: UIColor { return Cache.warning }
    public dynamic class var success: UIColor { return Cache.success }
    ...
    public dynamic class var glutenFreeColor: UIColor { return Cache.glutenFreeColor }
    public dynamic class var glutenFreeAccentColor: UIColor { return Cache.glutenFreeAccentColor }
    ...
    public dynamic class func drawScanSuccess(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 75, height: 75), resizing: ResizingBehavior = .aspectFit) {
        ...
        //// Oval Drawing
        let ovalPath = UIBezierPath(ovalIn: CGRect(x: 4, y: 4, width: 67, height: 67))
        NoodlesStyleKit.success.setFill()
        ovalPath.fill()
    ...
    public dynamic class func drawStartTimerIcon(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 32, height: 32), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// Oval Drawing
        let ovalPath = UIBezierPath(ovalIn: CGRect(x: 4, y: 5.5, width: 23.5, height: 23))
        NoodlesStyleKit.darkerOrange.setStroke()
        ovalPath.lineWidth = 3
        ovalPath.stroke()
        ...
        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 16, y: 10))
        bezierPath.addLine(to: CGPoint(x: 16, y: 19))
        bezierPath.addLine(to: CGPoint(x: 22, y: 15))
        NoodlesStyleKit.darkerOrange.setStroke()
        ...
        //// Bezier 2 Drawing
        let bezier2Path = UIBezierPath()
        bezier2Path.move(to: CGPoint(x: 13.5, y: 2.5))
        bezier2Path.addCurve(to: CGPoint(x: 18, y: 2.5), controlPoint1: CGPoint(x: 18, y: 2.5), controlPoint2: CGPoint(x: 18, y: 2.5))
        bezier2Path.addLine(to: CGPoint(x: 18, y: 2.5))
        NoodlesStyleKit.darkerOrange.setStroke()
    ...
    public dynamic class func drawGlutenFreeBadge(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 42, height: 15), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        
        //// Resize to Target Frame
        context.saveGState()
        let resizedFrame: CGRect = resizing.apply(rect: CGRect(x: 0, y: 0, width: 42, height: 15), target: targetFrame)
        context.translateBy(x: resizedFrame.minX, y: resizedFrame.minY)
        context.scaleBy(x: resizedFrame.width / 42, y: resizedFrame.height / 15)


        //// Bezier 3 Drawing
        let bezier3Path = UIBezierPath()
        bezier3Path.move(to: CGPoint(x: 39.15, y: 1.75))
        bezier3Path.addCurve(to: CGPoint(x: 41, y: 4.61), controlPoint1: CGPoint(x: 40.28, y: 2.42), controlPoint2: CGPoint(x: 41, y: 3.45))
        bezier3Path.addLine(to: CGPoint(x: 41, y: 10.39))
        bezier3Path.addCurve(to: CGPoint(x: 36.24, y: 14), controlPoint1: CGPoint(x: 41, y: 12.38), controlPoint2: CGPoint(x: 38.87, y: 14))
        bezier3Path.addLine(to: CGPoint(x: 5.76, y: 14))
        bezier3Path.addCurve(to: CGPoint(x: 1, y: 10.39), controlPoint1: CGPoint(x: 3.13, y: 14), controlPoint2: CGPoint(x: 1, y: 12.38))
        bezier3Path.addLine(to: CGPoint(x: 1, y: 4.61))
        bezier3Path.addCurve(to: CGPoint(x: 2.85, y: 1.75), controlPoint1: CGPoint(x: 1, y: 3.45), controlPoint2: CGPoint(x: 1.72, y: 2.42))
        bezier3Path.addCurve(to: CGPoint(x: 5.76, y: 1), controlPoint1: CGPoint(x: 3.68, y: 1.27), controlPoint2: CGPoint(x: 4.68, y: 1))
        bezier3Path.addLine(to: CGPoint(x: 36.24, y: 1))
        bezier3Path.addCurve(to: CGPoint(x: 39.15, y: 1.75), controlPoint1: CGPoint(x: 37.33, y: 1), controlPoint2: CGPoint(x: 38.33, y: 1.28))
        bezier3Path.close()
        ...
        //// Text Drawing
        let textRect = CGRect(x: 1, y: 1.5, width: 40, height: 12)
    ...
    public dynamic class func drawLongNoodles(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 44, height: 18), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        
        //// Resize to Target Frame
        context.saveGState()
        let resizedFrame: CGRect = resizing.apply(rect: CGRect(x: 0, y: 0, width: 44, height: 18), target: targetFrame)
        context.translateBy(x: resizedFrame.minX, y: resizedFrame.minY)
        context.scaleBy(x: resizedFrame.width / 44, y: resizedFrame.height / 18)


        //// Color Declarations
        let darkestGreen = NoodlesStyleKit.baseGreen.shadow(withLevel: 0.6)

        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 41.06, y: 1.93))
        bezierPath.addCurve(to: CGPoint(x: 43, y: 5.44), controlPoint1: CGPoint(x: 42.24, y: 2.74), controlPoint2: CGPoint(x: 43, y: 4.01))
        bezierPath.addLine(to: CGPoint(x: 43, y: 12.56))
        bezierPath.addCurve(to: CGPoint(x: 38, y: 17), controlPoint1: CGPoint(x: 43, y: 15.01), controlPoint2: CGPoint(x: 40.76, y: 17))
        bezierPath.addLine(to: CGPoint(x: 6, y: 17))
        bezierPath.addCurve(to: CGPoint(x: 1, y: 12.56), controlPoint1: CGPoint(x: 3.24, y: 17), controlPoint2: CGPoint(x: 1, y: 15.01))
        bezierPath.addLine(to: CGPoint(x: 1, y: 5.44))
        bezierPath.addCurve(to: CGPoint(x: 2.94, y: 1.93), controlPoint1: CGPoint(x: 1, y: 4.01), controlPoint2: CGPoint(x: 1.76, y: 2.74))
        bezierPath.addCurve(to: CGPoint(x: 6, y: 1), controlPoint1: CGPoint(x: 3.81, y: 1.34), controlPoint2: CGPoint(x: 4.86, y: 1))
        bezierPath.addLine(to: CGPoint(x: 38, y: 1))
        bezierPath.addCurve(to: CGPoint(x: 41.06, y: 1.93), controlPoint1: CGPoint(x: 39.14, y: 1), controlPoint2: CGPoint(x: 40.2, y: 1.34))
        bezierPath.close()
        NoodlesStyleKit.lighterGreen.setFill()
        bezierPath.fill()
        NoodlesStyleKit.darkerGreen.setStroke()
        ...
        bezier2Path.addLine(to: CGPoint(x: 38.5, y: 6))
        NoodlesStyleKit.lighterYellow.setFill()
        bezier2Path.fill()
        darkestGreen.setStroke()
        bezier2Path.lineWidth = 2
        bezier2Path.lineCapStyle = .round
        bezier2Path.stroke()
        ...
        bezier3Path.addLine(to: CGPoint(x: 38.5, y: 9))
        NoodlesStyleKit.lighterYellow.setFill()
        bezier3Path.fill()
        darkestGreen.setStroke()
        bezier3Path.lineWidth = 2
        ...
        bezier4Path.addLine(to: CGPoint(x: 38.5, y: 12))
        NoodlesStyleKit.lighterYellow.setFill()
        bezier4Path.fill()
        darkestGreen.setStroke()
        bezier4Path.lineWidth = 2
    ...
    public dynamic class var imageOfStartTimerIcon: UIImage {
        if Cache.imageOfStartTimerIcon != nil {
            return Cache.imageOfStartTimerIcon!
        }

        UIGraphicsBeginImageContextWithOptions(CGSize(width: 32, height: 32), false, 0)
            NoodlesStyleKit.drawStartTimerIcon()

        Cache.imageOfStartTimerIcon = UIGraphicsGetImageFromCurrentImageContext()!
        UIGraphicsEndImageContext()
    ...
    public dynamic class var imageOfGlutenFreeBadge: UIImage {
        if Cache.imageOfGlutenFreeBadge != nil {
            return Cache.imageOfGlutenFreeBadge!
        }

        UIGraphicsBeginImageContextWithOptions(CGSize(width: 42, height: 15), false, 0)
    ...
    public dynamic class var imageOfLongNoodles: UIImage {
        if Cache.imageOfLongNoodles != nil {
            return Cache.imageOfLongNoodles!
        }

        UIGraphicsBeginImageContextWithOptions(CGSize(width: 44, height: 18), false, 0)
    ...
    @IBOutlet dynamic var startTimerIconTargets: [AnyObject]! {
        get { return Cache.startTimerIconTargets }
        set {
    ...
    @IBOutlet dynamic var glutenFreeBadgeTargets: [AnyObject]! {
        get { return Cache.glutenFreeBadgeTargets }
        set {
            Cache.glutenFreeBadgeTargets = newValue
            for target: AnyObject in newValue {
                let _ = target.perform(NSSelectorFromString("setImage:"), with: NoodlesStyleKit.imageOfGlutenFreeBadge)
            }
        }
    }

    @IBOutlet dynamic var longNoodlesTargets: [AnyObject]! {
        get { return Cache.longNoodlesTargets }
        set {
            Cache.longNoodlesTargets = newValue
            for target: AnyObject in newValue {
                let _ = target.perform(NSSelectorFromString("setImage:"), with: NoodlesStyleKit.imageOfLongNoodles)
            }
        }
    }
