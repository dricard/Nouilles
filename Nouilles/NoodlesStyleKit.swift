...
//  Nouilles
//
//  Created by Denis Ricard on 2017-03-04.
...
public class NoodlesStyleKit : NSObject {
    ...
    public dynamic class func drawGlutenFreeBadge(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 42, height: 18), resizing: ResizingBehavior = .aspectFit) {
        ...
        //// Bezier 3 Drawing
        let bezier3Path = UIBezierPath()
        bezier3Path.move(to: CGPoint(x: 39.15, y: 1.93))
        bezier3Path.addCurve(to: CGPoint(x: 41, y: 5.44), controlPoint1: CGPoint(x: 40.28, y: 2.74), controlPoint2: CGPoint(x: 41, y: 4.01))
        bezier3Path.addLine(to: CGPoint(x: 41, y: 12.56))
        bezier3Path.addCurve(to: CGPoint(x: 36.24, y: 17), controlPoint1: CGPoint(x: 41, y: 15.01), controlPoint2: CGPoint(x: 38.87, y: 17))
        bezier3Path.addLine(to: CGPoint(x: 5.76, y: 17))
        bezier3Path.addCurve(to: CGPoint(x: 1, y: 12.56), controlPoint1: CGPoint(x: 3.13, y: 17), controlPoint2: CGPoint(x: 1, y: 15.01))
        bezier3Path.addLine(to: CGPoint(x: 1, y: 5.44))
        bezier3Path.addCurve(to: CGPoint(x: 2.85, y: 1.93), controlPoint1: CGPoint(x: 1, y: 4.01), controlPoint2: CGPoint(x: 1.72, y: 2.74))
        bezier3Path.addCurve(to: CGPoint(x: 5.76, y: 1), controlPoint1: CGPoint(x: 3.68, y: 1.34), controlPoint2: CGPoint(x: 4.68, y: 1))
        bezier3Path.addLine(to: CGPoint(x: 36.24, y: 1))
        bezier3Path.addCurve(to: CGPoint(x: 39.15, y: 1.93), controlPoint1: CGPoint(x: 37.33, y: 1), controlPoint2: CGPoint(x: 38.33, y: 1.34))
        bezier3Path.close()
    ...
    public dynamic class func drawLongNoodles(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 42, height: 18), resizing: ResizingBehavior = .aspectFit) {
        ...
        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 39.15, y: 1.93))
        bezierPath.addCurve(to: CGPoint(x: 41, y: 5.44), controlPoint1: CGPoint(x: 40.28, y: 2.74), controlPoint2: CGPoint(x: 41, y: 4.01))
        bezierPath.addLine(to: CGPoint(x: 41, y: 12.56))
        bezierPath.addCurve(to: CGPoint(x: 36.24, y: 17), controlPoint1: CGPoint(x: 41, y: 15.01), controlPoint2: CGPoint(x: 38.87, y: 17))
        bezierPath.addLine(to: CGPoint(x: 5.76, y: 17))
        bezierPath.addCurve(to: CGPoint(x: 1, y: 12.56), controlPoint1: CGPoint(x: 3.13, y: 17), controlPoint2: CGPoint(x: 1, y: 15.01))
        bezierPath.addLine(to: CGPoint(x: 1, y: 5.44))
        bezierPath.addCurve(to: CGPoint(x: 2.85, y: 1.93), controlPoint1: CGPoint(x: 1, y: 4.01), controlPoint2: CGPoint(x: 1.72, y: 2.74))
        bezierPath.addCurve(to: CGPoint(x: 5.76, y: 1), controlPoint1: CGPoint(x: 3.68, y: 1.34), controlPoint2: CGPoint(x: 4.68, y: 1))
        bezierPath.addLine(to: CGPoint(x: 36.24, y: 1))
        bezierPath.addCurve(to: CGPoint(x: 39.15, y: 1.93), controlPoint1: CGPoint(x: 37.33, y: 1), controlPoint2: CGPoint(x: 38.33, y: 1.34))
        bezierPath.close()
        NoodlesStyleKit.lighterGreen.setFill()
        bezierPath.fill()
        NoodlesStyleKit.darkerGreen.setStroke()
