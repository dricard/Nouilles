...
enum NetworkParams {
    ...
    // FATSECRET API
    static let FatSecretAPIBaseURL = "http://platform.fatsecret.com/rest/server.api"
    ...
    static func message(error: Int) -> String {
        switch error {
        case CodeFindByUPCRequestFailed:
            return .failureToReturnData
        case CodeSendRequestFailed:
            return .codeSendRequestFailed
        case CodeNoDataReturned:
            return .codeNoDataReturned
        case CodeCouldNotParseData:
            return .codeCouldNotParseData
        case CodeFindByStringRequestFailed:
            return .codeFindByStringRequestFailed
        default:
            return .codeByDefault
        }
    }
